...
<head>
    ...
    <title>Joel Gouend | My Blog</title>
    ...
    <main class="main-page-wrapper">
        <div class="container w-100" style="margin-top:200px;">
            <div class="row">
                {{-- central pane --}}
                <div class="col-lg-8">
                    <h3 class="text-center" style="font-size:40px; color:#0047AB;margin-bottom:8px;margin-bottom:20px;">Main Articles</h3>
                    @foreach($data as $article) 
                        <div class="card" style="font-size:12px!important;height:280px!important;margin-bottom:15px!important;">
                            <div class="row no-gutters">
                                <div class="col-md-8" style="background-color:#EDEADE;">
                                    <div class="card-body" style="padding-bottom: 10px;">
                                        <a href="{{url('/blog/article',$article->link)}}">
                                            <p style="margin-bottom: 5px; font-size:18px;">
                                                <small>
                                                    <i class="bi bi-person-square highlight-pr-color"></i> Redacted by <strong>{{$article->author}}</strong> <br>
                                                    <i class="bi bi-person-bounding-box highlight-pr-color"></i>
                                                    @if(count($article->reviewers)>0) 
                                                     Reviewed by
                                            ...
                                            <h5 class="card-title highlight-pr-color"
                                                style="font-size:24px; margin:10px 0px; margin-bottom:20px;">
                                                {{$article->title}}</h5>
                                            <p class="card-text post-overview" style="margin-bottom: 10px;font-size:19px;">
                                                {{$article->overview}}
                                            </p>
                                            <p class="card-text" style="margin-bottom: 0px; font-size:18px;">
                                                <i class="bi bi-calendar-date highlight-pr-color"></i> <small class="text-muted">{{$article->published_date}}</small>
                                            </p>
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <img src="{{asset('/images/'.$article->image)}}" alt="article image preview"
                                        style="height:100%;">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 offset-lg-1" style="">
                    <div style="margin-top:50px; margin-bottom:42px">
